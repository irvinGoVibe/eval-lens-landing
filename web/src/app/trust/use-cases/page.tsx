...
export const metadata: Metadata = {
  title: "EvalLens Use Cases: A Structured First Read for Shortlists",
  description:
    ...
    <>
      ...
      <main className="usecases section-lab ds">
          ...
          <div className="ds-hero__v" data-version="1">
            ...
            <div className="wrap ds-hero__inner">
              ...
              >
                ...
                <Button href="https://calendly.com/evallens/30min?utm_source=evallens_site&utm_medium=use_cases&utm_campaign=use-cases-hub" variant="glass">Book a workflow call</Button>
              </div>
            </div>
          </div>
        </section>
        ...
        <CtaBand
          ...
          primary={{ label: "Book a workflow call", href: "https://calendly.com/evallens/30min?utm_source=evallens_site&utm_medium=use_cases&utm_campaign=use-cases-hub" }}
