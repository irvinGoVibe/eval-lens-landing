    ...
    <>
      ...
      />
        ...
        <StatementHero
          ...
          ctas={[
            { label: "Book the parallel run", href: "https://calendly.com/evallens/30min?utm_source=evallens_site&utm_medium=use_cases&utm_campaign=vc-open-calls" },
        ...
        <section className="band light" aria-labelledby="seg-brand-h2">
          ...
          <div className="wrap">
            ...
            <p className="seg-note" data-reveal="up">
              ...
              <a href="https://calendly.com/evallens/30min?utm_source=evallens_site&utm_medium=use_cases&utm_campaign=vc-open-calls">book a call</a>.
            </p>
          </div>
        </section>
        ...
        <CtaBand
          ...
          primary={{ label: "Book the parallel run", href: "https://calendly.com/evallens/30min?utm_source=evallens_site&utm_medium=use_cases&utm_campaign=vc-open-calls" }}
