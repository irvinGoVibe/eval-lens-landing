...
const CSS = `
.dev-inspector{position:absolute;top:8px;right:8px;z-index:90;display:flex;flex-direction:column;gap:6px;
...
export function DevInspector() {
  useEffect(() => {
    ...
    function enhance(section: HTMLElement) {
      if (section.dataset.devInspector === "1") return;
      ...
      if (!labClass) return;
      section.dataset.devInspector = "1";
      ...
      cleanups.push(() => {
        ...
        panel.remove();
        delete section.dataset.devInspector;
      });
    }
