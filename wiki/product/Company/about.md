...
Help the visitor trust the team and understand the product mission.
...
```text
Explain the problem that motivated the product.
```
...
```text
Define the company's stance on AI.
```

Principles:

```text
AI prepares analysis
Humans make final decisions
Scores must be explainable
Evidence matters
Consistency should be visible
```
...
```text
Connect company story to product roadmap.
```
...
```text
Move visitors to contact or demo.
```
