...
| 11 | one-job-seven-rooms | One job, seven rooms | Research | violet | Организатор ищет инструмент «для своего сегмента». Перевернуть: сегмент не предсказывает боль; фит определяют три условия (объём × capacity × нужно защищать решение). Даём тест самодиагностики | Practical playbook | свежий ICP-лендинг (7 сегментных страниц, 13.08) + CRM-канон сегментов | «AI screening for accelerators / grant review software / does my program need AI screening» | 2026-08-15 | 8 сегментов CRM; паттерн квалификации; режимы Pitch/Hackathon; criteria weights на лидерборде; AI Total Score advisory vs Jury Score; 1,000+ runs | **written** |
