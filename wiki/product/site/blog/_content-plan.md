...
| 11 | one-job-seven-rooms | One job, seven rooms | Research | violet | Организатор ищет инструмент «для своего сегмента». Перевернуть: сегмент не предсказывает боль; фит определяют три условия (объём × capacity × нужно защищать решение). Даём тест самодиагностики | Practical playbook | свежий ICP-лендинг (7 сегментных страниц, 13.08) + CRM-канон сегментов | «does my program need AI screening / how to choose a screening tool» (commercial-запросы «AI screening for accelerators» / «grant review software» отданы сегментным страницам — см. keyword-map §5, статья кросслинкует на них) | 2026-08-15 | 8 сегментов CRM; паттерн квалификации; режимы Pitch/Hackathon; criteria weights на лидерборде; AI Total Score advisory vs Jury Score; 1,000+ runs | **published** |
| 10 | we-applied-to-y-combinator | We applied to Y Combinator | Press Release | violet | Build-in-public анонс подачи в YC Fall 2026; мета-угол «подались в самый большой batch-review мира» | (announcement) | заявка подана 27.07 до дедлайна (8pm PT); решение до 28.08 | «Y Combinator Fall 2026 batch» | 2026-07-28 | заявка компании (Downloads), Nha Trang event, LOI, Crypto Executives, 1,135 commits / 1,000+ runs | **published** |
