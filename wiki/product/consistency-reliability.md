...
Trust-страница: объясняет, как EvalLens делает стабильность оценки видимой —
...
- **Ключевое сообщение:** балл полезен, только если известно, насколько он
  устойчив. EvalLens вскрывает согласие, разброс и случаи, требующие человека —
...
- **Подзаголовок:** EvalLens показывает, где оценки стабильны, где судьи
...
EvalLens отслеживает `Spread(d)` между судьями и переводит его в понятную метку:
...
hackathon-прототипа и AI Jury к EvalLens прошёл через **400+ внутренних
прогонов** и проверку консистентности.

### 8. Граница надёжности + эскалация
EvalLens **не обещает** предсказать успех стартапа с уверенностью. Цель —
...
- **meta description:** Как EvalLens делает стабильность оценки видимой:
