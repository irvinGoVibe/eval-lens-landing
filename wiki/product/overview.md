...
EvalLens ведёт организатора по **7 шагам** (из `overview.md` / `user-flow.md`),
...
EvalLens — это три связанных модуля (bento, hero-тайл + 3):
...
### 6. Почему это важно
EvalLens снижает нагрузку ручного ревью, повышает консистентность оценки и даёт
...
- **meta description:** Как работает EvalLens: сбор заявок в Entry Hub, оценка
