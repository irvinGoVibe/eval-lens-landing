...
Trust-страница: объясняет, как EvalLens обращается с питч-деками, заявками,
...
- **Ключевое сообщение:** деки и результаты оценки — чувствительны. EvalLens
...
EvalLens **готовит анализ**, но финальные решения и использование отчёта
