---
slug: one-job-seven-rooms
category: Research
accent: violet
title: One job, seven rooms
excerpt: Seven kinds of selection programs describe their week in seven vocabularies and hire the same job. A three-condition test tells you whether your program is one of them, and what to do if it is not.
date: 2026-08-15
readMinutes: 8
cover: /assets/blog/seven-rooms/cover.png
...
:::gallery
![](/assets/blog/seven-rooms/short-version.png)
:::
...
Size of the pile is the wrong tell. Watch what your reviewers do when it grows. Under pressure, careful readers do not read faster. They read less. DocSend's 2024 data clocks the average investor's first read at 2 minutes and 30 seconds per deck ([DocSend](https://www.prnewswire.com/news-releases/investor-activity-surpasses-2021-engagement-levels-hits-q1-record-high-according-to-docsend-2024-data-302113696.html)), and their earlier research found that on a deck heading for a no, investors give up at 2:13 ([TechCrunch](https://techcrunch.com/2022/09/22/science-of-pitch-decks/amp)).

Two and a half minutes is what the calendar allows. Nobody chooses to skim slide nine.
...
The reason this matters is that human review is less consistent than most programs assume. Across 23,414 ratings at a national science fund, agreement between independent reviewers came out at an intraclass correlation of about 0.26 ([PLOS One](https://journals.plos.org/plosone/article?id=10.1371%2Fjournal.pone.0048509)). Two qualified experts, same proposal, different numbers. Unstructured expert judgment does that.

Training moves the number. In a controlled study, reviewers who went through a training program reached inter-rater reliability of 0.89, against 0.61 without it ([PLOS One](https://journals.plos.org/plosone/article?id=10.1371%2Fjournal.pone.0130450)).
...
:::gallery
![](/assets/blog/seven-rooms/three-conditions.png)
:::
...
:::gallery
![](/assets/blog/seven-rooms/what-changes.png)
:::
...
1. **Count the batch and the weeks.** Submissions in the cycle, divided by working days before the decision. That is your real reading time per submission, and most teams find it lower than they guessed.
2. **Count the readers, in hours.** Not people. Hours of senior attention that actually exist, from people who will not quietly hand it to an intern.
3. **Name who can ask why.** Write the actual names or roles. If the list is empty, stop here.
4. **Write the sentence you would have to say.** "We ranked this one above that one because ___." If you cannot finish it with something a stranger could check, you are not shopping for speed. You are shopping for defensibility, and those are different purchases.
5. **Pick the batch you already argued about.** Every program has one cycle where the shortlist was contested. That is the batch worth re-running, because you already know the answer and can see whether a structured pass would have surfaced it.
