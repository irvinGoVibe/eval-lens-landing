---
slug: building-for-the-gemini-xprize
category: Press Release
accent: violet
title: We're building for the Build with Gemini XPRIZE
excerpt: We're entering the $2M Build with Gemini XPRIZE with a new, AI-operated line of work — and we're going to be honest in public about the bar, because the contest grades the one thing we care about most: evidence.
date: 2026-06-28
readMinutes: 5
cover: /assets/blog/building-xprize/cover.png
...
The contest scores three things in [equal weight](https://xprize.devpost.com/rules), and we'd rather hold ourselves to them in the open:
...
1. Build with Gemini XPRIZE — official rules (prizes, dates, criteria, requirements) — https://xprize.devpost.com/rules
2. Build with Gemini XPRIZE — overview — https://xprize.devpost.com/
