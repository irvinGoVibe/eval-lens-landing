---
name: web-quality-seo
description: Technical on-page SEO from the Lighthouse/Google-guidelines angle — meta tags, canonical, robots, sitemap, heading structure, image SEO, JSON-LD snippets (Organization/Article/Product/FAQ/Breadcrumb). Use for "fix meta tags", "add structured data", "sitemap optimization", "technical SEO of a page". For a full site audit use seo-audit; for AI-search visibility use ai-seo; for pages at scale use programmatic-seo.
license: MIT
metadata:
