...
- пересобирать страницы, запускать `component-forge` / `build-pages`;
...
`.claude/library/component-library/` (сейчас не существует — создать):
...
production-patterns.json · conflicts.json · README.md
```
...
### Full — `/component-library-preparer "full"`
...
### Incremental (single-target) — `/component-library-preparer "<target>"`
