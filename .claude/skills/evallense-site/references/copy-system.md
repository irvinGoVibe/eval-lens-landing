...
- Trust-сигналы рядом с CTA (human-in-the-loop, 400+ runs, evidence-based).
...
- **Социальное доказательство:** 400+ evaluation runs; сегменты (VC, accelerators…); кейсы (когда появятся).
